...
/*   Updated: 2022/02/25 15:28:39 by cjimenez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    *init_content(t_data *data)
{
    ...
    data->collnbrmax = ft_get_nbr(data->map, 'C');
    ...
    data->img.mlx_win = mlx_new_window(data->img.mlx_ptr, data->x * GAMESIZE, data->y * GAMESIZE, "so_long_bonus");
    return (data);
}
